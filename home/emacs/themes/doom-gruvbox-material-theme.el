...
(def-doom-theme doom-gruvbox-material
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (org-level-1 :foreground red :weight 'semi-bold :height 1.4)
   (org-level-2 :foreground orange :weight 'semi-bold :height 1.2)
   (org-level-3 :foreground yellow :weight 'semi-bold :height 1.1)
   (org-level-4 :foreground green :weight 'semi-bold)
