...
(def-doom-theme doom-gruvbox-material
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (org-level-2 :foreground yellow :weight 'semi-bold :height 1.2)
   ...
   (org-level-6 :foreground dark-orange :weight 'semi-bold)
   (org-level-7 :foreground dark-yellow :weight 'semi-bold)
   (org-level-8 :foreground dark-green :weight 'semi-bold)
